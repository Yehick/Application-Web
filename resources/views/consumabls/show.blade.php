@extends('layouts.app')
@section('title', 'Ver detalles de los consumibles')
@section('content')
    ...
    <div class="row">
        <div class="card col-sm bg-light" style="width: 18rem;">
            ...
            <div class="card-body">
                <h5 class="card-title">{{ $consumabl->name }}</h5>
                <h3 class="card-text">{{ $consumabl->price }}</h3>
                <p class="card-text">{{ $consumabl->quantity }}</p>
                <div>
